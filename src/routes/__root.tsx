...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Reko — Recomendaciones de creadores LATAM" },
      {
        name: "description",
        content: "El link en la bio donde viven todas las recomendaciones de tus creadores favoritos.",
      },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <AdsProvider>
        ...
        <Outlet />
        <footer className="border-t border-border bg-surface px-4 py-8 text-center text-xs text-muted-foreground">
